...
public class LoanApplicationController {
    ...
    @PutMapping("/loan-application/{applicationId}/status")
    public ResponseEntity<Void> updateApplicationStatus(@PathVariable Long applicationId, @RequestBody String status) {
